...
provider "github" {
  # Configuration options
  token = "xxxxxxxxxxxxxxxxxxxxx"  # write your Githup token address
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"  /* write your Githup token address  */
          cd /home/ec2-user
          git clone https://$TOKEN@github.com/Klcknn/bookstore-api.git
