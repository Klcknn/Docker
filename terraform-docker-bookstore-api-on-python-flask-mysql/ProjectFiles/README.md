...
![Alt text](../images/bookstore-api.pngimage-1.png)
...
- Step 1: Download or clone project definition from `your-githup-repo` repo on Github
...
- [AWS Elastic Compute Cloud User Guide](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance)
- [Flask Mysql Guide](https://flask-mysql.readthedocs.io/en/stable/)
- [Flask Mysql Guide](https://flask-mysql.readthedocs.io/en/stable/)
- [Flask Version Guide](https://pypi.org/project/Flask/2.3.3/)
- [Terraform AWS Provider](https://registry.terraform.io/providers/hashicorp/aws/latest/docs)
- [Terraform Githup Resources and Providers](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/repository)
- [Terraform Githup Resources and Providers_2](https://registry.terraform.io/providers/integrations/github/latest/docs)
