...
- or build **`ec2-docker-compose.tf`** file :  **`terraform init`** --> **`terraform apply`** and Finally : **`terraform destroy`**  and 
- Connect to your instance with SSH (using docker-compose-public-ip = "54.173.97.173")
...
- Finally Connected Docker_Instance_2 with SSH connection (VsCode Remote Explorer)
